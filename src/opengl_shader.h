/* ---------------------------------------------------------------- *
    ...
    Desc.....Definition of kuu::opengl::Shader class.
 */
...
public:
    /* ------------------------------------------------------------ *
       Constructs the shader. The shader is not valid until vertex
       and fragment shader sources are set and the shader is linked.
     */
    Shader();
    ...
    /* ------------------------------------------------------------ *
       Links the shader. This will link the vertex and fragment
       shader into program.
     */
    void link();
    ...
    /* ------------------------------------------------------------ *
       ...
       name.....The uniform name.
       matrix...The uniform matrix value.
     */
